        ...
        <PageTransition>
          ...
          <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div className="rounded-2xl border border-white/10 bg-bg-soft/50 p-4 text-center backdrop-blur-xl">
              ...
              <div className="mt-1 font-display text-xl font-bold text-emerald2-400">$0</div>
            </div>
            <div className="rounded-2xl border border-white/10 bg-bg-soft/50 p-4 text-center backdrop-blur-xl">
              ...
              <div className="mt-1 font-display text-xl font-bold text-gold">-</div>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            {active.length === 0 ? (
              <div className="rounded-3xl border border-white/10 bg-bg-soft/50 p-10 text-center backdrop-blur-xl">
                ...
                <p className="mt-3 text-sm text-slate-400">No active competitions yet</p>
                <p className="mt-1 text-xs text-slate-500">Check back soon for upcoming trading competitions</p>
              </div>
            ) : (
          ...
          <div className="mb-8 rounded-3xl border border-white/10 bg-bg-soft/50 p-4 backdrop-blur-xl sm:p-5">
            ...
            {past.length === 0 ? (
              <p className="py-6 text-center text-sm text-slate-500">No past competitions yet</p>
            ) : (
          ...
          <div className="rounded-3xl border border-white/10 bg-bg-soft/50 p-4 backdrop-blur-xl sm:p-5">
            ...
            {userHistory.length === 0 ? (
              <p className="py-6 text-center text-sm text-slate-500">No competition history yet</p>
            ) : (
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
